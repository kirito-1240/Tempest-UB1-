...
async def reedme(e):
    await e.edit(
        ...
        "\n[TEMPEST-USERBOT README.md file](https://github.com/kirito-1240/TempestUB/blob/master/README.md)"
    )
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit("Here is my [Repo](https://github.com/kirito-1240/TempestUB)")
